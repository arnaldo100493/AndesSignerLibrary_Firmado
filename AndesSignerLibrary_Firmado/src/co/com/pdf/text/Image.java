...
public abstract class Image extends Rectangle implements Indentable, Spaceable, IAccessibleElement, IAlternateDescription {
    ...
    public static Image getInstance(URL url, boolean handleIncorrectImage) throws BadElementException, MalformedURLException, IOException {
        InputStream is = null;
        try {
            is = url.openStream();
            int c1 = is.read();
    ...
    public static Image getInstance(String filename, boolean handleIncorrectImage) throws IOException, BadElementException {
    ...
    public static Image getInstance(byte[] imgb, boolean handleIncorrectImage) throws BadElementException, MalformedURLException, IOException {
        InputStream is = null;
        try {
