...
// Source File Name:   CertificadosPersonaNaturalRUTRequest.java
...
@XmlRootElement(name = "CertificadosPersonaNaturalRUTRequest")
public class CertificadosPersonaNaturalRUTRequest {

    public CertificadosPersonaNaturalRUTRequest() {
        this.tipoCert = 0;
        this.tipoDoc = 0;
        this.documento = "";
        this.nombres = "";
